...
import com.example.user.test_fix_sensor_version2.record_2;
        ...
        confirm.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if(action_name.getText().toString().length()==0 ||
                    ...
                    Intent intent = new Intent(context,com.example.user.test_fix_sensor_version2.pebble.pebble_record_2.class);
