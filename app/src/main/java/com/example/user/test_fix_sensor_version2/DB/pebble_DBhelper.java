 ...
 */
public class pebble_DBhelper extends SQLiteOpenHelper {

    private static final int DATEBASE_VERSION =2;
    private static final String DATABASE_NAME = "actions.db";
    public static final String TABLE_ACTIONS = "pebble_actions";//table  isn't equal to database name
    public static final String TABLE_ACTIONS_2 = "actions";
    ...
    public static final String DROP_TABLE_SQL="DROP TABLE IF EXISTS pebble_actions";
    ...
    public pebble_DBhelper(Context context){
